...
const Anchor = ({ href, children }) => (
  <a
    ...
    className="mx-2 text-lightPrimaryText hover:text-lightLink transition-colors duration-300"
...
const About = () => {
  ...
  return (
    <animated.div
      style={fadeIn}
      id="about"
      className="container mx-auto flex flex-col items-center justify-center bg-lightBackground min-h-screen"
    >

      <animated.div style={slideUp}>
        <p className="text-lg text-lightPrimaryText mb-4 text-center px-8">
